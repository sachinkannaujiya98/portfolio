...
const Testimonial = () => {
  return (
    <div>
      ...
      <div className='flex flex-col gap-y-4 md:flex-row justify-evenly items-center mt-20'>

        <div className='min-h-[150px] w-[90%] md:w-[45%] border-[#A1ABBF] border-2 rounded-md skew-y-3 hover:skew-y-0 shadow-2xl shadow-[#A1ABBF]'>
